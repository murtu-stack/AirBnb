...
export default function PlacePages() {
  ...
  function input_header(text) {
    return <h2 className="text-lg mt-4  a nbgyu ">{text}</h2>;
  }
        ...
        <div>
          <form>
            ...
            <div className="flex items-center gap-2 ">
              ...
              />
              <button className="bg-gray rounded-xl p-2 my-1 text-sm">
                Add&nbsp;Photo
              </button>
            </div>

            <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 ">
              <button className=" flex justify-center gap-4 border bg-transparent p-4 rounded-xl">
                Upload
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
